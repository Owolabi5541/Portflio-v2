...
import padiImg from '../assets/ScamTrustBG.jpg'
import padiLogo from '../assets/ScamTrust.png'
    ...
    const items = [
        {
            ...
            proBackground: 'absolute flex items-center justify-center w-full opacity-[0.8] h-full bg-[#00008B] rounded-[20px]',
            proIntro: 'Experience a super comfortable financial lifestyle that supports your daily habits.',
            proLink: 'https://www.scamtrust.net/',
            aos: 'fade-right',
            offset: "100", 
            easing: "ease-in-sine",
            duration: "2000"
       ...
       <div className="flex flex-col items-start justify-center w-full lg:w-full">
        ...
        <div className='flex items-center justify-center w-full mt-3'>
            <p className='text-sm text-[#74aabc] md:text-base xl:text-lg'>
             ...
             <a  href="mailto:Owolabiidris4@gmail.com.com?subject=" target="_blank" rel="noreferrer"
