  ...
  const items = [
    {
      ...
      details: 'Collaborated closely with frontend designers, UI designer and other back-end developers to create visually stunning and functional Escrow app. while ensuring cross-browser-compatibility and optimized website performance for a seamless experience.',
    },
    {
      id: 2,
      title: 'Interships',
